...
# 15-epoch STH-Align (vs 1 epoch in 08_align_full.sh).
# Also uses FoveaBlur / uncertainty-aware features (DirectT override removed from align/data.py).
# Reads the retrained checkpoint from runs/full_v2 output by 07b.
