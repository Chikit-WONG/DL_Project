...
from ATMS_reconstruction import ATMS, evaluate_model, train_model
from eegdatasets_leaveone import EEGDataset


def main():
    parser = argparse.ArgumentParser(description="Smoke test for ATM reconstruction encoder training on a small class subset")
    ...
    print("Smoke reconstruction completed")
