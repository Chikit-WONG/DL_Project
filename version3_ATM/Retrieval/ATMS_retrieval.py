...
def main():
    ...
    parser.add_argument('--data_path', type=str, default="/hpc2hdd/home/ckwong627/workdir/Class/DSAA2012-Deep_Learning/ChiKitWONG/Assignments/Project/DL_Project/image-eeg-data", help='Path to the EEG dataset')
    ...
    parser.add_argument('--logger', type=str2bool, default=False, help='Enable WandB logging')
