#!/bin/bash
#SBATCH -p long_gpu
#SBATCH -o /hpc2hdd/home/ckwong627/workdir/Class/DSAA2012-Deep_Learning/ChiKitWONG/Assignments/Project/DL_Project/version5_VED/slurm_scripts/logs/05_run_task2_full_%j.out
#SBATCH -e /hpc2hdd/home/ckwong627/workdir/Class/DSAA2012-Deep_Learning/ChiKitWONG/Assignments/Project/DL_Project/version5_VED/slurm_scripts/logs/05_run_task2_full_%j.err
#SBATCH -n 8
#SBATCH --gres=gpu:1
