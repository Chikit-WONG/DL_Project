...
#   sbatch task1/slurm_scripts/05_full_train_12blur_evnet.sh
#
#SBATCH -p emergency_gpua40
#SBATCH -o task1/slurm_scripts/logs/05_full_train_12blur_evnet_%j.out
#SBATCH -e task1/slurm_scripts/logs/05_full_train_12blur_evnet_%j.err
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
# Phase B: 12-blur + EVNet fixed, full train
...
python main_eeg_course.py \
    --blur_config 12 --use_evnet --use_full_train --epoch 200 --train_batch_size 1024 --lr 0.001 --n_seeds 10 --first_seed 21 --feature_path output/Image_feature --output_dir output/logs/12blur_evnet_full \
