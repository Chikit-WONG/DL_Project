#!/bin/bash
#SBATCH -p debug
#SBATCH -o /hpc2hdd/home/ckwong627/workdir/Class/DSAA2012-Deep_Learning/ChiKitWONG/Assignments/Project/main/task1/slurm_scripts/logs/01_gen_evnet_features_%j.out
#SBATCH -e /hpc2hdd/home/ckwong627/workdir/Class/DSAA2012-Deep_Learning/ChiKitWONG/Assignments/Project/main/task1/slurm_scripts/logs/01_gen_evnet_features_%j.err
#SBATCH -n 4
#SBATCH --gres=gpu:1
