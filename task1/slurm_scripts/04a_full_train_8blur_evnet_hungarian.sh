...
#   sbatch task1/slurm_scripts/04a_full_train_8blur_evnet_hungarian.sh
#
#SBATCH -p emergency_gpua40
#SBATCH -o task1/slurm_scripts/logs/04a_full_train_8blur_evnet_hungarian_%j.out
#SBATCH -e task1/slurm_scripts/logs/04a_full_train_8blur_evnet_hungarian_%j.err
#SBATCH -n 8
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
...
python main_eeg_course.py \
    --blur_config 8 --use_evnet --use_full_train --epoch 200 --train_batch_size 1024 --lr 0.001 --n_seeds 10 --first_seed 21 --feature_path output/Image_feature --output_dir output/logs/8blur_evnet_full --hungarian \
