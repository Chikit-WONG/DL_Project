...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_evnet',        action='store_true', help='Use EVNet preprocessed features', default=False)
    ...
    logger.info('='*60)
    logger.info(f'Results with EVNet={args.use_evnet} (val-selected model):')
